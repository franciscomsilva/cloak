...
#if DEBUG_PRINT_PACKETS_HOOK
    global_packets_received += 1;
    probePrint("[global_packets_received]: " + std::to_string(global_packets_received));
#endif
...
void Call::OnRecoveredPacket(const uint8_t* packet, size_t length) {
  // TODO(bugs.webrtc.org/11993): Expect to be called on the network thread.webrtc_patches_chromium_100
