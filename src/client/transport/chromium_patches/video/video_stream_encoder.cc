...
void VideoStreamEncoder::OnFrame(Timestamp post_time,
  ...
  if (frames_scheduled_for_processing == 1 && !cwnd_frame_drop) {
    ...
    if (cwnd_frame_drop) {
      ...
      global_dropped_frames_congestion_window +=1;
      probePrint("[global_dropped_frames_congestion_window]: " + std::to_string(global_dropped_frames_congestion_window));
#endif
...
#if DEBUG_PRINT_FRAMES_HOOK
      global_dropped_frames_by_encoder_queue +=1;
      probePrint("[global_dropped_frames_by_encoder_queue]: " + std::to_string(global_dropped_frames_by_encoder_queue));
#endif
      encoder_stats_observer_->OnFrameDropped(
...
#if DEBUG_PRINT_FRAMES_HOOK
    global_dropped_frames_by_source += 1;
    probePrint("[global_dropped_frames_by_source]: " + std::to_string( global_dropped_frames_by_source));
#endif
  encoder_stats_observer_->OnFrameDropped(
...
#if DEBUG_PRINT_FRAMES_HOOK
    global_dropped_frames_size += 1;
    probePrint("[global_dropped_frames_size]: " + std::to_string(global_dropped_frames_size));
#endif
...
#if DEBUG_PRINT_FRAMES_HOOK
     global_dropped_frames_media_optimization += 1;
     probePrint("[global_dropped_frames_media_optimization]: " + std::to_string(global_dropped_frames_media_optimization));
#endif
    OnDroppedFrame(
...
#if DEBUG_PRINT_FRAMES_HOOK
      global_dropped_frames_by_encoder += 1;
      probePrint("[global_dropped_frames_by_encoder]: " + std::to_string(global_dropped_frames_by_encoder));
#endif
    }
  }
